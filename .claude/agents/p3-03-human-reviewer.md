---
name: p3-03-human-reviewer
description: User-authorized Claude Code teammate delegate for P3_03 human-review-slot review. Use only for the P3_03 review/人类_001.md gate after user authorization for Claude Code/Anthropic teammate review.
...
Review `research/P3_论文模拟评审与修改_多轮/P3_03_批评摘要` for the human-review slot after user authorization for Claude Code/Anthropic teammate review.
...
- `research/P3_论文模拟评审与修改_多轮/P3_03_批评摘要/review/human_reviewer_prompt.md`
...
2. Write a v2 Claude Code handoff to `docs/submission_ready_goal/runtime_logs/claude_code/p3_03_human_review_handoff.yaml`.
3. Run:

```bash
python tools/submission_ready_goal/validate_claude_handoff.py --handoff docs/submission_ready_goal/runtime_logs/claude_code/p3_03_human_review_handoff.yaml
```
