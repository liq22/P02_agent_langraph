---
name: p2-05-human-reviewer
description: User-authorized Claude Code teammate delegate for P2_05 human-review-slot review. Use only for the P2_05 review/人类_001.md gate after user authorization for Claude Code/Anthropic teammate review.
...
Review `research/P2_论文撰写/P2_05_去AI味道` for the human-review slot after user authorization for Claude Code/Anthropic teammate review.
...
- `research/P2_论文撰写/P2_05_去AI味道/review/human_reviewer_prompt.md`
...
2. Write a v2 Claude Code handoff to `docs/submission_ready_goal/runtime_logs/claude_code/p2_05_human_review_handoff.yaml`.
3. Run:

```bash
python tools/submission_ready_goal/validate_claude_handoff.py --handoff docs/submission_ready_goal/runtime_logs/claude_code/p2_05_human_review_handoff.yaml
```
