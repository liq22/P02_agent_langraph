# P2_02_01_引言 research prompt

## 节点定位
- phase: `P2`
- node_kind: `leaf`
- node_path: `research/P2_论文撰写/P2_02_初稿_md/P2_02_01_引言`
- node_mode: `lite`
...
### 可交接条件
- 引言能让外行 reviewer 理解问题、gap 和贡献预告
