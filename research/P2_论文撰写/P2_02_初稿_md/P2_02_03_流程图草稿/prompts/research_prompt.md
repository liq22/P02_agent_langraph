# P2_02_03_流程图草稿 research prompt

## 节点定位
- phase: `P2`
- node_kind: `leaf`
- node_path: `research/P2_论文撰写/P2_02_初稿_md/P2_02_03_流程图草稿`
- node_mode: `standard`
...
4. 默认必须补齐的 node-local 输入：`../artifacts/outline_map.yaml`, `docs/manuscript.md`。
