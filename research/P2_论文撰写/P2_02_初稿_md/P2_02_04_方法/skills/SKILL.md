---
name: P2_02_04_方法_node_skill
description: Node-local strategy skill for `research/P2_论文撰写/P2_02_初稿_md/P2_02_04_方法`.
  Use only when this node's tier requires `skills/SKILL.md`.
---

# P2_02_04_方法 Node Skill

This node-local skill applies to `research/P2_论文撰写/P2_02_初稿_md/P2_02_04_方法`.
