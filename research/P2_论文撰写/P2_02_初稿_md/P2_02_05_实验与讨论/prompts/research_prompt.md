# P2_02_05_实验与讨论 research prompt

## 节点定位
- phase: `P2`
- node_kind: `leaf`
- node_path: `research/P2_论文撰写/P2_02_初稿_md/P2_02_05_实验与讨论`
- node_mode: `standard`
...
## 本轮目标
### 节点职责
- 推进实验与讨论写作，并在必要时先做 claim-result 对齐。
- 这是 leaf node，重点是完成当前节点最小可验证产出，不扩张到其他节点。

### 必答研究问题
- 最重要结果应先出现吗？
- 是否明确 primary/secondary outcomes？
- 讨论是否区分发现、解释和局限？
...
4. 默认必须补齐的 node-local 输入：`../artifacts/outline_map.yaml`, `docs/manuscript.md`, `artifacts/claim_map.yaml`, `../../../P1_实验设计与仓库蓝图/P1_05_初步验证结果整理/artifacts/claim_evidence_registry.yaml`。
