---
name: P2_03_定稿_tex_node_skill
description: Node-local strategy skill for `research/P2_论文撰写/P2_03_定稿_tex`. Use only
  when this node's tier requires `skills/SKILL.md`.
---

# P2_03_定稿_tex Node Skill

This node-local skill applies to `research/P2_论文撰写/P2_03_定稿_tex`.
