---
name: P2_05_去AI味道_node_skill
description: Node-local strategy skill for `research/P2_论文撰写/P2_05_去AI味道`. Use only
  when this node's tier requires `skills/SKILL.md`.
---

# P2_05_去AI味道 Node Skill

This node-local skill applies to `research/P2_论文撰写/P2_05_去AI味道`.
...
- Default path: delegate to canonical worker `deai_cn_skill`.
