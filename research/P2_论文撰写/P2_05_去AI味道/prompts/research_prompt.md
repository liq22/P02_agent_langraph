# P2_05_去AI味道 research prompt

## 节点定位
- phase: `P2`
- node_kind: `leaf`
- node_path: `research/P2_论文撰写/P2_05_去AI味道`
- node_mode: `standard`
...
## 本轮目标
### 节点职责
- 做学术表达与主张校准，提升 clarity、precision、claim restraint 与跨领域可读性，保持证据边界不变。
...
4. 默认必须补齐的 node-local 输入：`docs/manuscript.md`。
