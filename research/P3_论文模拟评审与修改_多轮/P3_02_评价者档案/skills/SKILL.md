---
name: P3_02_评价者档案_node_skill
description: Node-local strategy skill for `research/P3_论文模拟评审与修改_多轮/P3_02_评价者档案`.
  Use only when this node's tier requires `skills/SKILL.md`.
---

# P3_02_评价者档案 Node Skill

This node-local skill applies to `research/P3_论文模拟评审与修改_多轮/P3_02_评价者档案`.
