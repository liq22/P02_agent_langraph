# P4_01_审稿意见收集 research prompt

## 节点定位
- phase: `P4`
- node_kind: `leaf`
- node_path: `research/P4_论文回复_response/P4_01_审稿意见收集`
- node_mode: `standard`
...
## 本轮目标
### 节点职责
- 收集并压缩当前 node 的审稿意见，形成后续映射输入。
- 这是 leaf node，重点是完成当前节点最小可验证产出，不扩张到其他节点。

### 必答研究问题
- comments 是否被完整保留？
- 多条评论是否需要拆分？
- editor comment 是否单独标识？

### 本轮最小交付
- 标准化 comments 列表 (需由本节点形成或更新)
