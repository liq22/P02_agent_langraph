---
name: P4_01_审稿意见收集_node_skill
description: Node-local strategy skill for `research/P4_论文回复_response/P4_01_审稿意见收集`.
  Use only when this node's tier requires `skills/SKILL.md`.
---

# P4_01_审稿意见收集 Node Skill

This node-local skill applies to `research/P4_论文回复_response/P4_01_审稿意见收集`.
