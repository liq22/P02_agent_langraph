---
name: P4_04_正式回复_tex_或_doc_node_skill
description: Node-local strategy skill for `research/P4_论文回复_response/P4_04_正式回复_tex_或_doc`.
  Use only when this node's tier requires `skills/SKILL.md`.
---

# P4_04_正式回复_tex_或_doc Node Skill

This node-local skill applies to `research/P4_论文回复_response/P4_04_正式回复_tex_或_doc`.
