# P4_04_正式回复_tex_或_doc research prompt

## 节点定位
- phase: `P4`
- node_kind: `leaf`
- node_path: `research/P4_论文回复_response/P4_04_正式回复_tex_或_doc`
- node_mode: `standard`
...
- 回复语气冷静专业，能指出具体修改位置
- point-by-point、clear description of changes、格式一致
