---
name: P4_06_修改证据_node_skill
description: Node-local strategy skill for `research/P4_论文回复_response/P4_06_修改证据`.
  Use only when this node's tier requires `skills/SKILL.md`.
---

# P4_06_修改证据 Node Skill

This node-local skill applies to `research/P4_论文回复_response/P4_06_修改证据`.
