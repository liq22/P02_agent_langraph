---
name: P1_03_仓库蓝图_node_skill
description: Node-local strategy skill for `research/P1_实验设计与仓库蓝图/P1_03_仓库蓝图`. Use
  only when this node's tier requires `skills/SKILL.md`.
---

# P1_03_仓库蓝图 Node Skill

This node-local skill applies to `research/P1_实验设计与仓库蓝图/P1_03_仓库蓝图`.
