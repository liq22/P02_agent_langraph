---
name: P1_01_数据层_集中数据与子模块引用_node_skill
description: Node-local strategy skill for `research/P1_实验设计与仓库蓝图/P1_01_数据层_集中数据与子模块引用`.
  Use only when this node's tier requires `skills/SKILL.md`.
---

# P1_01_数据层_集中数据与子模块引用 Node Skill

This node-local skill applies to `research/P1_实验设计与仓库蓝图/P1_01_数据层_集中数据与子模块引用`.
