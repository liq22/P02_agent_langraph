# P1_06_03_子模块仓库引用 research prompt

## 节点定位
- phase: `P1`
- node_kind: `leaf`
- node_path: `research/P1_实验设计与仓库蓝图/P1_06_代码仓库_已有_重新初始化_子模块策略/P1_06_03_子模块仓库引用`
- node_mode: `standard`
...
## 本轮目标
### 节点职责
- 厘清子模块引用策略及其与主仓库的边界关系。
- 这是 leaf node，重点是完成当前节点最小可验证产出，不扩张到其他节点。

### 必答研究问题
- 为什么必须是 submodule，而不是 copy / package / API？
- 版本如何钉住？
- 如果上游变动怎么办？

### 本轮最小交付
- submodule policy (需由本节点形成或更新)
- 版本/来源/许可清单 (需由本节点形成或更新)
