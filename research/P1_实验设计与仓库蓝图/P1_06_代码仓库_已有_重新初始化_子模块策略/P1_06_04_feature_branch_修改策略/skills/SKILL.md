---
name: P1_06_04_feature_branch_修改策略_node_skill
description: Node-local strategy skill for `research/P1_实验设计与仓库蓝图/P1_06_代码仓库_已有_重新初始化_子模块策略/P1_06_04_feature_branch_修改策略`.
  Use only when this node's tier requires `skills/SKILL.md`.
---

# P1_06_04_feature_branch_修改策略 Node Skill

This node-local skill applies to `research/P1_实验设计与仓库蓝图/P1_06_代码仓库_已有_重新初始化_子模块策略/P1_06_04_feature_branch_修改策略`.
