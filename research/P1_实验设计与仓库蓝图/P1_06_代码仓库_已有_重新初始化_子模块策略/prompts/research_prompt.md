# P1_06_代码仓库_已有_重新初始化_子模块策略 research prompt

## 节点定位
- phase: `P1`
- node_kind: `scope`
- node_path: `research/P1_实验设计与仓库蓝图/P1_06_代码仓库_已有_重新初始化_子模块策略`
- node_mode: `parent`
...
## 本轮目标
### 节点职责
- 协调 `P1_06_代码仓库_已有_重新初始化_子模块策略` 子树推进，并把执行保持在子节点而不是父节点壳层。
- 这是 scope node，重点是协调 ready child 与局部状态，不替子节点代工。

### 必答研究问题
- 哪些代码应放主仓，哪些应接入，哪些应子模块？
- 如何降低未来维护成本与版本混乱？
- 如何保证最小改动和可回滚？
