---
skill_id: P1_06_代码仓库_已有_重新初始化_子模块策略_local_entry
...
This shim applies to `research/P1_实验设计与仓库蓝图/P1_06_代码仓库_已有_重新初始化_子模块策略`.
